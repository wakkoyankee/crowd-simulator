...
public class Window {
	...
	public Window() {
		...
		try {
			crsURL = new File(
					"C:\\Users\\carte\\Desktop\\crowd-simulator\\Projet\\src\\main\\java\\crs_sim\\texturePack\\test.gif")
							.toURI().toURL();
			gjPanicURL = new File(
					"C:\\Users\\carte\\Desktop\\crowd-simulator\\Projet\\src\\main\\java\\crs_sim\\texturePack\\test.gif")
							.toURI().toURL();
			gjNeutralURL = new File(
					"C:\\Users\\carte\\Desktop\\crowd-simulator\\Projet\\src\\main\\java\\crs_sim\\texturePack\\test.gif")
							.toURI().toURL();
			gjAggURL = new File(
					"C:\\Users\\carte\\Desktop\\crowd-simulator\\Projet\\src\\main\\java\\crs_sim\\texturePack\\test.gif")
	...
	class Panel extends JPanel {
		...
		public void paintComponent(Graphics g) {
			...
			if (bodies != null) {
				for (Percept body : bodies) {
					...
					if (body.getName() == Types.building) {
						...
						g.fillRect((int) r.getMinX() + ParamSimu.mapLeftOffset, (int) r.getMinY(),
								(int) (r.getMaxX() - r.getMinX()), (int) (r.getMaxY() - r.getMinY()));
						...
						// labelCRS[i].setLocation((int)(c.getX() + ParamSimu.mapLeftOffset), (int)
						// c.getY());
						...
						// labelGJAgg[i].setLocation((int)(c.getX() + ParamSimu.mapLeftOffset), (int)
						// c.getY());
						...
						// labelGJPanic[i].setLocation((int) c.getX() + ParamSimu.mapLeftOffset, (int)
						// c.getY());
						...
						// labelGJNeutral[i].setLocation((int)(c.getX() + ParamSimu.mapLeftOffset),
						// (int) c.getY());
			...
			/*
			 * g.setColor(Color.GREEN); g.fillRect((int) (ParamSimu.mapLeftOffset +
			 * ParamSimu.neutralObj.getMinX()), (int) (ParamSimu.neutralObj.getMinY()),
