...
public class A1 extends Agent {
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.info("The agent was started. yoopi");
  }
  ...
  @Inject
  @Deprecated
  public A1(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public A1(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
