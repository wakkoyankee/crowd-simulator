...
public class Protester extends Agent {
  ...
  @SyntheticMember
  public Protester(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public Protester(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public Protester(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
